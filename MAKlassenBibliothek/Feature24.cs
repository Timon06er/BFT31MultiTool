...
class Program
{
        ...
        do
        {
            ...
            switch (choice)
            {
                ...
                case "2":
                    ...
                    Console.WriteLine("Enter your bet: ");
                    double bet2 = GetUserBet(stattkapital) - 1;
    ...
    static double GetUserBet(double stattkapital)
    {
        double bet;
        do
        {
    ...
    static void RouletteGame(ref double stattkapital, double bet)
    {
        int betRangeChoice;
        ...
        do
        {
            ...
            if (int.TryParse(Console.ReadLine(), out betRangeChoice))
            {
        ...
        } while (betRangeChoice != 0);
    }

    static void BlackjackGame(ref double stattkapital, double bet)
    {
    ...
    static void PlayBlackjack(ref double stattkapital, double bet)
    {
        Deck deck = new Deck();
        deck.Shuffle();
    ...
    static void PlayerTurn(Deck deck, List<Card> hand)
    {
    ...
    static void DealerTurn(Deck deck, List<Card> hand)
    {
    ...
    static void DetermineWinner(List<Card> playerHand, List<Card> dealerHand, ref double stattkapital, double bet)
    {
    ...
    static string CardListToString(List<Card> hand)
    {
