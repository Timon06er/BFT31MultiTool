...
internal class Feature24
{
    ...
    private static double GetUserBet(double stattkapital)
    {
        double bet;
        do
        {
    ...
    private static void RouletteGame(ref double stattkapital, double bet)
    {
    ...
    private static void BlackjackGame(ref double stattkapital, double bet)
    {
    ...
    private static void PlayBlackjack(ref double stattkapital, double bet)
    {
        Deck deck = new Deck();
        deck.Shuffle();
    ...
    private static void PlayerTurn(Deck deck, List<Card> hand)
    {
    ...
    private static void DealerTurn(Deck deck, List<Card> hand)
    {
    ...
    private static void DetermineWinner(List<Card> playerHand, List<Card> dealerHand, ref double stattkapital, double bet)
    {
    ...
    private static string CardListToString(List<Card> hand)
    {
